...
<body>
	...
	<form method="post" action="controller">
		...
		<input id="title-input" name="title" type="text" minlength="1"/>
		<br/>
		<label for="author-input">Author: </label>
		<input id="author-input" name="author" type="text" minlength="1"/>
		<br/>
		<label for="isbn-input">isbn: </label>
		<input id="isbn-input" name="isbn" type="text" minlength="1"/>
		<br/>
		<label for="pages-input">Pages: </label>
		<input id="pages-input" name="pages" type="number" minlength="1"/>
		<br/>
		<label for="price-input">Price: </label>
		<input id="price-input" name="price" type="text" minlength="1"/>
		<br />
