...
public class CommandFactory {
	...
	private CommandFactory() {
		...
		commands.put("orders",
				new OrdersCommand(ServiceFactory.INSTANCE.getService(OrderService.class), PagingUtil.INSTANCE));
		commands.put("checkout_order", new CreateOrderCommand(ServiceFactory.INSTANCE.getService(OrderService.class)));
		commands.put("update_order_form",
				new UpdateOrderFormCommand(ServiceFactory.INSTANCE.getService(OrderService.class)));
		commands.put("increase_quantity",
				new IncreaseQuantityCommand(ServiceFactory.INSTANCE.getService(OrderService.class)));
		commands.put("decrease_quantity",
				new DecreaseQuantityCommand(ServiceFactory.INSTANCE.getService(OrderService.class)));
